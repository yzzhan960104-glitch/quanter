...
PILOT_BUILD_STAMP: 2026-08-28 14:09:22 +0800 2c85bc7d [exp]（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-08-28 14:09:22 +0800 2c85bc7d [exp]'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
