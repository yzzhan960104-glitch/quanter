...
PILOT_BUILD_STAMP: 2026-08-28 12:14:55 +0800 aa101850（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-08-28 12:14:55 +0800 aa101850'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
