...
PILOT_BUILD_STAMP: 2026-08-29 16:21:43 +0800 9786492d（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-08-29 16:21:43 +0800 9786492d'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
