...
PILOT_BUILD_STAMP: 2026-09-01 09:47:13 +0800 4456dbe2（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-09-01 09:47:13 +0800 4456dbe2'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
