...
PILOT_BUILD_STAMP: 2026-08-25 19:48:14 +0800 31974cb3（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-08-25 19:48:14 +0800 31974cb3'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
