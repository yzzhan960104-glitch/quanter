...
PILOT_BUILD_STAMP: 2026-08-27 13:53:12 +0800 bba6d09e（部署核对：编辑器 Ctrl+F 搜本串，与仓库 git log -1 比对）。
"""
...
PILOT_BUILD_STAMP = '2026-08-27 13:53:12 +0800 bba6d09e'   # 版本锚（git HEAD 提交时间 + 短 hash）——部署核对用
