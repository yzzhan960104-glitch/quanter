...
# 退役说明（2026-07-27）：原 fetch_north_flow / fetch_dragon_list / _cleanse_north 三方法
# 随 north_flow / dragon_list 两湖整体退役而删除（akshare 北向资金 24 行废弃态、龙虎榜近 1 月；
# 北向权威源已切 moneyflow_hsgt.north_money，龙虎榜机构席位走 top_inst）。AKShareClient 主体
# 保留——fetch_daily_hist / fetch_macro_raw / fetch_margin_detail 等仍服务 macro_credit 等在产湖。
