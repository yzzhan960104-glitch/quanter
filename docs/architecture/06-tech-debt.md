> 最近复核：2026-08-16（N5 Low 批处置 + stale 勘误）· 维护者：debt-full-wave session ·
...
flowchart LR
  ...
  subgraph NEW["🔶 2026-08-15 新登记（本轮发现）"]
    ...
    LC["🔶【Low】波次遗留清理清单<br/>N5 已处置 ②③⑨⑪（本波）<br/>+ ⑦⑩ stale 勘误<br/>余项 ①④⑤⑥⑧⑫-⑮ 各源 follow-up"]:::low
  end
