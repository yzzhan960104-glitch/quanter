...
REM Why .bat 包装：schtasks 默认 cwd=%WINDIR%\System32，直接跑 python data/tools/sync_incremental.py
...
"C:\Users\yzzhan\Desktop\quanter\.venv310\Scripts\python.exe" data/tools/sync_incremental.py >> data_lake/.syncing/sync_incremental.stdout.log 2>&1
