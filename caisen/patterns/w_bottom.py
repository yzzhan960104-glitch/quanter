...
物理意图与白皮书 12 招对齐（《多空转折策略白皮书.md》招 1 W 底）；其中 26 周线/
幅宽张力/量价配合等防御性过滤为经典形态学补充（非原著逐字，作为可选风控保留，
以白皮书为权威源——旧 docs/caisen-methodology-summary.md 的 OCR 与白皮书冲突，
其"实战篇方法论"疑为幻觉，相关规则已降级为可选过滤，不再标"原著直接"）：
