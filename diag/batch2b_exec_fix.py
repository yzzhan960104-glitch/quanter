...
GRID = [
    ("max_holding", 20), ("max_holding", 25), ("max_holding", 40),
    ("time_stop_days", 6.0), ("time_stop_days", 10.0), ("time_stop_days", 12.0),
    ("__combo__ts8_g5", 1),   # 组合：time_stop8 + trailing_grace5（批①双正向）
]
...
def _cell(job):
    ...
    if key == "__combo__ts8_g5":
        base["time_stop_days"] = 8.0
        base["trailing_grace"] = 5.0
        key, val = "combo_ts8_g5", 1
    split = holdout_split()
